...
(function($)
{
    ...
    $.widget("ui.multiselect", {
        ...
        _create:function()
        {
            ...
            this.availableList = $('<ul class="available connected-list"  style="height: ' + this.options.height + ' !important;"><li class="ui-helper-hidden-accessible"></li></ul>').bind('selectstart',
                function()
                {
                    return false;
