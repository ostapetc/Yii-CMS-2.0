...
CHANGE COLUMN `is_visible` `is_published`  tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Отображать' AFTER `module_id`;
...
HEAD;
	...
	{
		echo "m120225_213735_is_published2 does not support migration down.\n";
		return false;
