...
<div class="container">
	...
	<p class="message">
		<? echo nl2br(htmlspecialchars($data['message'],ENT_QUOTES,Yii::app()->charset))?>
	</p>

	<div class="source">
		<p class="file"><? echo htmlspecialchars($data['file'],ENT_QUOTES,Yii::app()->charset)."({$data['line']})"?></p>
