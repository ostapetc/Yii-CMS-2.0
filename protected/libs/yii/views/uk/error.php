...
<title>Помилка <? echo $data['code']; ?></title>
...
<body>
<h1>Помилка <? echo $data['code']; ?></h1>
<h2><? echo nl2br(CHtml::encode($data['message'])); ?></h2>
<p>
При опрацюванні веб-сервером вашого запита виникла вказана вище помилка.
</p>
<p>
Якщо ви вважаєте, що це помилка налаштування сервера, зверніться за адресою <? echo $data['admin']; ?>.
</p>
<p>
Дякуємо.
</p>
