...
###Особенности написания Контроллеров  {#controllers}
...
###Особенности написания View  {#views}
...
###Особенности написания Model  {#models}
...
###Особенности написания Форм  {#forms}
...
###Написание Виджетов и прочих компонентов  {#widgets}
