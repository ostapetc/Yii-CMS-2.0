<?
class m120701_004651_menu_create extends EDbMigration
{
    public function up()
    {
        ...
        $this->execute("
            CREATE TABLE `menu` (
                ...
                CONSTRAINT `menu_language_fk` FOREIGN KEY (`language`) REFERENCES `languages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
