...
(function($) {
	...
	$.widget("ui.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		toArray: function(o) {
			...
			ret.push({"item_id": 'root', "parent_id": 'none', "depth": sDepth + 1, "left": '1', "right": ($('li', this.element).length + 1) * 2});
			...
			function _recursiveArray(item, depth, left) {
				...
				if (id != null) {
						ret.push({"item_id": id[2], "parent_id": pid, "depth": depth + 1, "left": left, "right": right});
				}
